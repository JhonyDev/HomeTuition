...
public class Math79Shapes extends AppCompatActivity {
    ...
    public static void initSound() {
        switch (selectedLayout + 1) {
            case 1:
                Utils.speak(context, "Sphere");
                break;
            case 2:
                Utils.speak(context, "Cuboid");
                break;
            case 3:
                Utils.speak(context, "Cylinder");
                break;
            case 4:
                Utils.speak(context, "Cube");
                break;
            case 5:
                Utils.speak(context, "Cone");
                break;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_math79_shapes);
        context = this;
        initLayouts(this, 0, "alphabet_");
    }
}