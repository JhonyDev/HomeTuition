...
public class AAndAnActivity extends AppCompatActivity {
    ...
    public static void speak() {
        switch (selectedLayout + 1) {
            case 1:
                Utils.speak(context, "an apple");
                break;
            case 2:
                Utils.speak(context, "an egg");
                break;
            case 3:
                Utils.speak(context, "a kangaroo");
                break;
            case 4:
                Utils.speak(context, "a net");
                break;
            case 5:
                Utils.speak(context, "an umbrella");
                break;
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aand_an);
        context = this;
        initLayouts(this, 0, "");
    }
}