...
public class EvenOddActivity extends AppCompatActivity {
    ...
    public static void speak() {
        switch (selectedLayout + 1) {
            case 1:
                Utils.speak(context, "4 even");
                break;
            case 2:
                Utils.speak(context, "6 even");
                break;
            case 3:
                Utils.speak(context, "8 even");
                break;
            case 4:
                Utils.speak(context, "10 even");
                break;
            case 5:
                Utils.speak(context, "1 odd");
                break;
            case 6:
                Utils.speak(context, "3 odd");
                break;
            case 7:
                Utils.speak(context, "5 odd");
                break;
            case 8:
                Utils.speak(context, "7 odd");
                break;
