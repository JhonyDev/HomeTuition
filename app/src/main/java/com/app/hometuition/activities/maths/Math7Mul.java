...
public class Math7Mul extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maths_mul_div);
    ...
    private void refresh() {
        ...
        int id = 0;
        Utils.speak(this, showGr1 + " multiplied by");
        ...
        String words = showGr1 + " x " + showGr2 + " = " + showGr3;
