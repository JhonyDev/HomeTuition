...
public class MosamActivity extends AppCompatActivity {
    ...
    public static void speak() {
        switch (selectedLayout + 1) {
            case 1:
                Utils.speakUrdu(context, "موسم بہار");
                break;
            case 2:
                Utils.speakUrdu(context, "موسم گرما");
                break;
            case 3:
                Utils.speakUrdu(context, "موسم سرما");
                break;
            case 4:
                Utils.speakUrdu(context, "خزاں");
                break;
        }
    }
