...
public class UrduBasicColors extends AppCompatActivity {
    ...
    public static void speak() {
        switch (selectedLayout + 1) {
            case 1:
                Utils.speakUrdu(context, "لال");
                break;
            case 2:
                Utils.speakUrdu(context, "نیلا");
                break;
            case 3:
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_urdu_basic_colors);
        context = this;
        initLayouts(this, 0, "");
